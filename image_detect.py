...
class YOLO(object):
    _defaults = {
        ...
        "classes_path": 'trafic_sign_dataset/classes.txt',
        "score" : 0.6,
        "iou" : 0.35,
    ...
    def detect_image(self, image):
        ...
        for i, c in reversed(list(enumerate(out_classes))):
            ...
            label = '{} {:.2f}'.format("Ograniczenie predkosci", score)
    ...
    def detect_img(self, image, video):
        if video == True:
...
if __name__=="__main__":
    yolo = YOLO()
    image = '40km.jpg'
    r_image, ObjectsList = yolo.detect_img(image, False)
    print(ObjectsList)
